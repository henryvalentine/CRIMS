...
function enrolleeTableManager(baseUrl, tableDirective, tableOptions, edit, custom, bio, addButtonLabel) {
    ...
    var jTable = tableDirective.dataTable({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex) {
            ...
            var editStr = '<a data-edit-id="' + aData[0] + '" onclick="' + edit + '(\'' + aData[0] + '\')" class="editBtn" alt="Edit" title="Edit" id="' + aData[0] + '" style="cursor: pointer"><img src="' + baseUrl + '/Content/img/edit.png" /></a>';
            var custDataStr = '<a alt="Custom Data" title="Custom Data"  onclick="' + custom + '(\'' + aData[0] + '\')" data-edit-id="' + aData[0] + '" id="' + aData[0] + '" style="cursor: pointer" class="dataBtn"><img src="' + baseUrl + '/Content/img/details.png" /></a>';
            var bioStr = '<a class="bioBtn"  onclick="' + bio + '(\'' + aData[0] + '\')" data-edit-id="' + aData[0] + '" alt="Capture Biodata" title="Capture Biodata" id="trf' + aData[0] + '" style="cursor: pointer"><img src="' + baseUrl + '/Content/img/fingerprint.png" style="height: 17px; width:22px"/></a>';
...
function aprovalsTableManager(baseUrl, tableDirective, tableOptions, edit, custom, history) {
    ...
    var jTable = tableDirective.dataTable({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex) {
            ...
            var historyStr = '', editStr = '', custDataStr = '';

            if (edit !== undefined && edit !== null && edit.length > 0) {
                editStr = '<a data-edit-id="' + aData[0] + '" onclick="' + edit + '(\'' + aData[0] + '\')" class="editBtn" title="Edit" id="' + aData[0] + '" style="cursor: pointer"><img src="' + baseUrl + '/Content/img/edit.png" /></a>';
            }
            if (custom !== undefined && custom !== null && custom.length > 0) {
                custDataStr = '<a title="Enrollment Details"  onclick="' + custom + '(\'' + aData[0] + '\')" data-edit-id="' + aData[0] + '" id="' + aData[0] + '" style="cursor: pointer" class="dataBtn"><img src="' + baseUrl + '/Content/img/details.png" /></a>';
            }

            if (history !== undefined && history !== null && history.length > 0) {
                historyStr = '<a class="bioBtn"  onclick="' + history + '(\'' + aData[0] + '\')" data-edit-id="' + aData[0] + '" title="View Approval History" id="trf' + aData[0] + '" style="cursor: pointer"><img src="' + baseUrl + '/Content/img/info.png" /></a>';
            }

            var template = '<td style="width: 5%">' + editStr + '&nbsp;' + custDataStr + '&nbsp;' + historyStr + '</td>';
            var ttd = $('td:last', nRow);
            ttd.after(template);
            return nRow;
        }
...
function rejectionsTableManager(baseUrl, tableDirective, tableOptions, custom, history) {
    ...
    var jTable = tableDirective.dataTable({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex) {
            ...
            if (history !== undefined && history !== null && history.length > 0) {
                bioStr = '<a class="bioBtn"  onclick="' + history + '(\'' + aData[0] + '\')" data-edit-id="' + aData[0] + '" title="Pull out of Rejection" id="trf' + aData[0] + '" style="cursor: pointer"><img src="' + baseUrl + '/Content/img/info.png" /></a>';
            }

            var template = '<td style="width: 5%">' + custDataStr + '&nbsp;' + bioStr + '</td>';
            var ttd = $('td:last', nRow);
            ttd.after(template);
            return nRow;
        }
    ...
    var jTable = tableDirective.dataTable({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex) {
            ...
            if (deleteFunc !== undefined && deleteFunc !== null && deleteFunc.length > 0) {
                delStr = '<a title="Custom Data"  onclick="' + deleteFunc + '(\'' + aData[0] + '\')" data-edit-id="' + aData[0] + '" id="' + aData[0] + '" style="cursor: pointer" class="dataBtn"><img src="' + baseUrl + '/Content/img/details.png" /></a>';
            }

            var template = '<td style="width: 5%">' + editStr + '&nbsp;&nbsp;' + delStr + '</td>';
            var ttd = $('td:last', nRow);
            ttd.after(template);
            return nRow;
        }
